...
<html lang="en">
<head>
  <title>Revalidar oportunidade</title>
        ...
        <div class="text-center col-md-5">
          ...
          <?php
            ...
            <div class="d-flex justify-content-between  col-md-12">
              <button class="btn btn-success col-md-5 mb-5" onclick="atualizarStatus(' . $idOportunidade . ', \'revalidar\')"><span>Revalidar <br>oportunidade</span></button>
