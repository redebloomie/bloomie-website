    ...
    <div class="row justify-content-start align-items-start g-0">
      ...
      <?php
        ...
        while ($oportunidade = $oportunidades->fetch_assoc()) {
          echo '
          <div class="oportunidade-container-expand col-8 g-0">
          ...
          echo '
          <div class="oportunidades-parecidas col-8">
            <h2>Se você gostou disso, também pode gostar de...</h2>
            <span class="col-12" style="gap:0;width: 100%;justify-content: space-between">';
